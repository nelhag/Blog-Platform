...
public class PostTest {
	...
	public void PostShouldHaveAuthorObject() {
		...
		Date publishDateTest = new Date(6, 27, 2019);
		Post postUnderTest = new Post("post1", "Post1 Body", publishDateTest, "category1", "tags1", author1, author2);
        ...
        List <Author> authors1  =postUnderTest.getAuthors();
		assertThat(title, is("post1"));
		assertThat(body, is("Post1 Body"));
		assertThat(publishedDate, is(publishDateTest));
		assertThat(category, is("category1"));
		assertThat(tags, is("tags1"));
		assertThat(authors,is(authors1));
